...
revert back the etherType to `TYPE_IPV4`.s
...
git pull
```
In your local root directory of your repository (e.g. /home/student/34351_P4_Student_Exercise). If any further additions or corrections are made by the course instructors ( the PhD students basically ;) ), then you can run the same command to apply the repository changes to your local machine.
